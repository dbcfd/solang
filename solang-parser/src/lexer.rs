...
impl<'input> fmt::Display for Token<'input> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Token::OffchainStruct => write!(f, "offchainStruct"),
            Token::Struct => write!(f, "struct"),
            Token::Event => write!(f, "event"),
            Token::Enum => write!(f, "enum"),
            Token::Type => write!(f, "type"),
            Token::OffchainRead => write!(f, "offchainRead"),
            Token::OffchainWrite => write!(f, "offchainWrite"),
...
static KEYWORDS: phf::Map<&'static str, Token> = phf_map! {
    ...
    "memory" => Token::Memory,
    "new" => Token::New,
    "offchainRead" => Token::OffchainRead,
    "offchainStruct" => Token::OffchainStruct,
    "offchainWrite" => Token::OffchainWrite,
